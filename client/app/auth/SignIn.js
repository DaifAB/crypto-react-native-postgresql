  ...
  function login() {
    ...
    firebase
      ...
      .then(async (user) => {
        ...
        try {
          const newUser = await axios
            .post(API_URL + "user/add/" + user.user.uid)
            .then((response) => {
              setLoading(false);
            ...
            <>
              <View style={styles.loginView}>
                ...
                <View style={styles.inputSection}>
                  <Image source={emailImg} style={styles.loginIcon}></Image>
                  <TextInput
                    style={styles.input}
                ...
                <View style={styles.inputSection}>
                  <Image source={passwordLock} style={styles.loginIcon}></Image>
                  <TextInput
                    style={styles.input}
                    placeholderTextColor="#93a6b1"
