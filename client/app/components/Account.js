    ...
    <View style={styles.container}>
      ...
      {user && user ? (
        <>
          ...
          <Text style={{ color: "#93a6b1", marginTop: 15, fontSize: 18 }}>
            test@gmail.com
          </Text>
          <View
            style={{
          ...
          >
            ...
            <View>
              <Text style={{ color: "#767576", fontSize: 18 }}>
                {user.localCrncy}
              </Text>
          ...
          <TouchableOpacity onPress={() => history.push("/")}>
            <Text
              style={{ color: "#93a6b1", fontSize: 18, marginVertical: 15 }}
            >
              log out
            </Text>
          </TouchableOpacity>
