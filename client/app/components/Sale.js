...
export default function Sale(props) {
  ...
  return (
    <View style={styles.container}>
      <BackButton route="/account" jwt={jwt} style={{ marginBottom: 0 }} />
      <Picker
      ...
      >
        {wallets &&
          wallets.map((wallet) => (
            <Picker.Item
              label={wallet.cryp_name}
              value={wallet.cryp_name}
              key={wallet.id}
            />
          ))}
      ...
      <TextInput
        placeholder="enter value want to sell "
        placeholderTextColor="#93a6b1"
        style={[
          styles.buyInput,
          { marginVertical: 15, padding: 3, color: "white" },
        ]}
        onChangeText={setValue}
        keyboardType="decimal-pad"
      />
      <TextInput
        placeholder="enter wallet number want to sell "
        placeholderTextColor="#93a6b1"
        style={[
          styles.buyInput,
          { marginVertical: 15, padding: 3, color: "white" },
      ...
      />
      <TouchableOpacity
        style={[styles.buyBtn, { marginTop: 0 }]}
        onPress={() => sell()}
      >
